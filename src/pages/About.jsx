...
const About = () => {
  return (
    <div className="">
      ...
      <div className="my-10 flex flex-col md:flex-row gap-16 shadow-2xl max-md:p-5 p-3 rounded-3xl bg-white">
        <img
      ...
      <div className="flex flex-col md:flex-row text-sm mb-20 shadow-2xl p-3 rounded-3xl bg-white">
